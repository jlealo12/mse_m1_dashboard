...
vsmTbl <- pData %>% 
  ...
  summarise_at(vars(time.min, vel.kmh), funs(mean, sd))

knitr::kable(vsmTbl,digits = 2,col.names = c("Categoría","Sexo","Tiempo promedio","SD tiempo","Velocidad promedio","SD velocidad"))
```
> Las velocidades se muestran en km/h y los tiempos en minutos.
> Aunque los tiempos de carrera de las mujeres son mayores, sus desviaciones son menores en cada categoría, indicando mayor consistencia en sus desempeños.
